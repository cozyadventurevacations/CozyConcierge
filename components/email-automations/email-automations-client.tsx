  ...
  return (
    ...
    >
      ...
      {result && (
        ...
        >
          <p style={{ margin: "0 0 12px", fontWeight: 700, color: "var(--accent-dark)" }}>
            ✓ Run complete for {result.date}
          </p>
          <div style={{ display: "flex", gap: 24, flexWrap: "wrap", marginBottom: 12 }}>
            <div>
              <span style={{ fontSize: 12, color: "#888", display: "block" }}>Sent</span>
              <span style={{ fontSize: 22, fontWeight: 800, color: "#166534" }}>{result.sentCount}</span>
            </div>
            <div>
              <span style={{ fontSize: 12, color: "#888", display: "block" }}>Skipped</span>
              <span style={{ fontSize: 22, fontWeight: 800, color: "#555" }}>{result.skippedCount}</span>
            </div>
            <div>
          ...
          {result.sent.length > 0 && (
            <div style={{ marginBottom: 8 }}>
              <p style={{ margin: "0 0 4px", fontSize: 13, fontWeight: 700, color: "#166534" }}>Sent:</p>
          ...
          {result.skipped.length > 0 && (
            <div style={{ marginBottom: 8 }}>
              <p style={{ margin: "0 0 4px", fontSize: 13, fontWeight: 700, color: "#555" }}>Skipped (already sent):</p>
          ...
          {result.errors.length > 0 && (
            <div>
              <p style={{ margin: "0 0 4px", fontSize: 13, fontWeight: 700, color: "#991b1b" }}>Errors:</p>
